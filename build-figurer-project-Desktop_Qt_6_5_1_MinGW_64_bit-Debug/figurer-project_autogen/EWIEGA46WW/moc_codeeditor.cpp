...
#include "../../../figurer-project/codeeditor.h"
...
Q_CONSTINIT const QMetaObject CodeEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QCodeEditor::staticMetaObject>(),
...
void *CodeEditor::qt_metacast(const char *_clname)
{
    ...
    return QCodeEditor::qt_metacast(_clname);
}

int CodeEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QCodeEditor::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
